...
public class StateServiceTests {
    ...
    @Test
    @Transactional
    public void createInvalidStateTest(){
        assertThrows(javax.persistence.EntityNotFoundException.class, () -> stateService.create(null));
    }
    ...
    public void getInvalidUserByIdTest(){
        assertThrows(javax.persistence.EntityNotFoundException.class, () -> stateService.readById(-1L));
    }
    ...
    @Test
    public void invalidGetByNameTest(){
        assertThrows(javax.persistence.EntityNotFoundException.class, () -> stateService.getByName(null));
    }
