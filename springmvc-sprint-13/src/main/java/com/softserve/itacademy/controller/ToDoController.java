...
public class ToDoController {
    ...
    public String read(@PathVariable long id, Model model) {
        ...
        model.addAttribute("ownerName", todoService.readById(id).getOwner().getFirstName());
    ...
    public String update(@PathVariable("todo_id") long todo_id, @PathVariable("owner_id") long owner_id, Model model) {
    ...
    public String update(@PathVariable("todo_id") long todo_id, @PathVariable("owner_id") long owner_id,
                         @ModelAttribute("todo") @Valid ToDo todo, BindingResult result) {
        if (result.hasErrors()) {
            return "update-todo";
        }
